                            ...
                            <div class="px-3 row align-items-center">
                                <div class="col-lg-6">
                                    <div class="input-group input-group-outline">                 
                                        ...
                                        <input type="text" maxlength="6" id="regis_voterOTP" name="regis-voter-OTP" class="form-control" required/>
                                    </div>
                                </div>  
                                <div class="col-auto">
                                    <a id="resend_voterOtp" class="ms-1 mt-1 link-primary" style="font-size: small;text-decoration: none;cursor:pointer;">Resend Code</a>  
                                </div>  
                            </div> 
                        </div>
                        <button type="submit" name="verify_voterOTPBtn" class="btn btn-primary text-white btn-block my-4 px-4 form-control">VERIFY</button>
                    </form>
                </div>
